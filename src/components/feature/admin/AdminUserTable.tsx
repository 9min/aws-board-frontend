      ...
      <table className="w-full text-sm">
        <thead className="bg-[hsl(var(--muted))]">
          <tr>
            ...
            <th className="px-4 py-3 text-left font-medium text-[hsl(var(--muted-foreground))]">이메일</th>
            <th className="px-4 py-3 text-left font-medium text-[hsl(var(--muted-foreground))]">닉네임</th>
            <th className="px-4 py-3 text-left font-medium text-[hsl(var(--muted-foreground))]">역할</th>
            <th className="px-4 py-3 text-left font-medium text-[hsl(var(--muted-foreground))]">게시글</th>
            <th className="px-4 py-3 text-left font-medium text-[hsl(var(--muted-foreground))]">댓글</th>
            <th className="px-4 py-3 text-left font-medium text-[hsl(var(--muted-foreground))]">가입일</th>
        ...
        <tbody className="divide-y divide-[hsl(var(--border))] bg-[hsl(var(--card))]">
          {users.map((user) => (
            <tr key={user.id} className="hover:bg-[hsl(var(--muted)/0.3)]">
              ...
              <td className="px-4 py-3 text-[hsl(var(--muted-foreground))]">{formatDate(user.createdAt)}</td>
              <td className="px-4 py-3">
                <AdminDeleteButton
